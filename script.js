...
users.forEach((element) => {
  clutter += ` <div class="card">
        <div class="div1">
          ...
          ${element.available ? `<button>Available </button>` : `<div> </div>`}
          <h1>$ ${element.rate}/hr</h1>
        </div>
        <div class="div2">
          <img
          ...
          <h2>
         ${element.designation}</h2>
          <h3>${element.company}</h3>
        </div>
        <div class="div3">
          <button>${element.skills[0]}</button>
          <button>${element.skills[1]}</button>
          <button>${element.skills[2]}</button>
          <button> +${element.skills.length - 3}</button>
        </div>
        <div class="div4">
          <p>
            ${element.description}
